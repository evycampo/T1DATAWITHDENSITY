...
Normality check of the variable IMDb and Rotten.Tomatoes
```{r}
...
```
Here p value for IMDb and Rotten.Tomatoes is less than 0.05. That's mean these are not normally distributed. Histogram of IMDb is right-skewed also Histogram of Rotten.Tomatoes is slightly left-skewed.
```{r}
...
```
Here p value for IMDb and Rotten.Tomatoes is less than 0.05. That's mean these are not normally distributed. Histogram of IMDb is right-skewed also Histogram of Rotten.Tomatoes is slightly Bimodal.
```{r}
...
```
Here p value for IMDb and Rotten.Tomatoes is less than 0.05. That's mean these are not normally distributed. Histogram of IMDb is right-skewed also Histogram of Rotten.Tomatoes is Randomly distribution.
...
```
Here p value for IMDb and Rotten.Tomatoes is less than 0.05. That's mean these are not normally distributed. Histogram of IMDb is slightly right-skewed and randomly distributed. also Histogram of Rotten.Tomatoes is slightly left-skewed and randomly distribution.