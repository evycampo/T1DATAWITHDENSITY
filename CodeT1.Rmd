...
=======
>>>>>>> 722df3512dad063520f16adb7ea550e63ee7ec68
...
```{r results='markup'}
prime2=subset(primetv, Age!="13+")

contable5= table(prime2$Age, prime2$IMDb)
contable5
chitest5 = chisq.test(contable5)
chitest5

contable6 = table(prime2$Age, prime2$Rotten.Tomatoes)
contable6
...
```{r results='markup'}
disney2=subset(disneytv, Age!="13+")

contable7= table(disney2$Age, disney2$IMDb)
contable7
chitest7 = chisq.test(contable7)
chitest7

contable8 = table(disney2$Age, disney2$Rotten.Tomatoes)
contable8
